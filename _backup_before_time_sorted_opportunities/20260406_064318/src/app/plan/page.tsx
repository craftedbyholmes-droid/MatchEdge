  ...
  try {
    ...
    opportunities = events
      .map((event) => {
        ...
        return {
          ...built,
          eventDate: event.commence_time || event.startTime || event.start_time || null,
        };
      })
      .filter(Boolean);
  } catch (err) {
  ...
  return (
    <AppShell>
      <PageHeader
        ...
        description="Premium unlocks the planner. Pro unlocks minimum profit filtering and higher-quality 7-day selection controls."
      />
