export const PERSONAS = {
  gordon: { id: 'gordon', name: 'Gaffer Gordon', colour: '#0F6E56', markets: ['match_result','ht_result','double_chance'], minGap: 12, minPicks: 2, maxPicks: 4, bestPickStake: 15, standardStake: 5, bio: 'The ex-manager. Reads the game tactically.' },
