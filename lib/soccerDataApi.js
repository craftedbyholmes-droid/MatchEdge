...
export const COVERED_LEAGUES = [
  { sd_id: 228, name: 'Premier League',   country: 'england',  code: 'EPL', tier: 1 },
  ...
  { sd_id: 289, name: 'Premiership',      country: 'scotland', code: 'SPL', tier: 1 },
...
export const PRO_LEAGUE_IDS = [228, 229, 231, 232, 230, 237]
