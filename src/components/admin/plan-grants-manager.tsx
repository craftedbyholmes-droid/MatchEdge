...
export function PlanGrantsManager({
  ...
  async function handleSaveGrant() {
    ...
    setStatus(`Grant saved. Resolved plan is now ${String(json.resolvedPlan || "free").toUpperCase()}. Refresh admin to confirm.`);
  }
  ...
  return (
    <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-6">
      ...
      <p className="mt-2 text-sm text-slate-400">
        This rewritten flow uses a single active manual grant per user. Saving a new grant replaces any older active grant.
      </p>
