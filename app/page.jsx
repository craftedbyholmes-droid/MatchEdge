    ...
    <div style={{ paddingBottom: '40px' }}>
      ...
      <div style={{ textAlign: 'center', padding: '48px 16px 40px' }}>
        ...
        <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          <Link href='/dashboard' style={{ background: '#1c1c28', color: '#9ca3af', padding: '12px 28px', borderRadius: '6px', fontWeight: 600, fontSize: '15px', textDecoration: 'none', border: '1px solid #2a2a3a' }}>See Today Picks</Link>
        </div>
      </div>
